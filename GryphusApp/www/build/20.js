...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__challenge_users__ = __webpack_require__(354);
...
var ChallengeUsersPage = /** @class */ (function () {
    ...
    ChallengeUsersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-challenge_users',template:/*ion-inline-start:"D:\DocFam\Descargas\Fedsoft\pruebas\GryphusApp\src\pages\challenge_users\challenge_users.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Mis Retos\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n\n  <button ion-button (click)="getDisponibles()" class="button">Disponibles</button>\n  <br>\n  <button ion-button (click)="getActuales()" class="button">Actuales</button>\n  <br>\n  <button ion-button (click)="getHistorial()" class="button">Historial</button>\n\n</ion-content>'/*ion-inline-end:"D:\DocFam\Descargas\Fedsoft\pruebas\GryphusApp\src\pages\challenge_users\challenge_users.html"*/
        }),
