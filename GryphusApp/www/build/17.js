...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__challenge_usershist__ = __webpack_require__(357);
...
var ChallengeUsersHistPage = /** @class */ (function () {
    ...
    ChallengeUsersHistPage = ChallengeUsersHistPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({
            selector: 'page-challenge_usershist',template:/*ion-inline-start:"D:\DocFam\Descargas\Fedsoft\pruebas\GryphusApp\src\pages\challenge_usershist\challenge_usershist.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title>\n      Historial de Retos\n    </ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <p>Historial_____Prueba de lectura de campo: {{this.usuarioActual.id}} / {{this.usuarioActual.email}} / {{this.usuarioActual.token}}</p>\n\n  <ion-list>\n    <ion-item *ngFor="let reto of retos">\n      <p>IdRegistro: {{reto.id}}, IDReto: {{reto.challenge.id}}, NombreReto: {{reto.challenge.descripcion}}, FechaInicio: {{reto.fechainicio}}, FechaFin: {{reto.fechafin}}</p>\n    </ion-item>\n  </ion-list>\n</ion-content>'/*ion-inline-end:"D:\DocFam\Descargas\Fedsoft\pruebas\GryphusApp\src\pages\challenge_usershist\challenge_usershist.html"*/
        }),
    ...
    var ChallengeUsersHistPage_1, _a, _b, _c;
}());
